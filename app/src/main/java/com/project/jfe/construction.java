...
public class construction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView_con();
        I=findViewById(R.id.imageView10);
        I.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(construction.this,MainActivity.class);
                startActivity(intent);
            }
        });
    }

    private void recyclerView_con() {
        ...
        FirebaseRecyclerOptions<job> option =
                new FirebaseRecyclerOptions.Builder<job>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("my_job").child("Construction"), job.class)
                        .build();
        rv_adapter = new RV_adapter(option,construction.this);
